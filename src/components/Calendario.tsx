...
export default function Calendar({ conferencias }: CalendarProps) {
  ...
  const [selectedReservacion, setSelectedReservacion] = useState<Conferencia | null>(null);
  ...
  // Función para abrir el modal con los detalles de la reservación
  const handleConferenciaClick = (conferencia: Conferencia, event: React.MouseEvent) => {
    event.stopPropagation();
    setSelectedReservacion(conferencia);
    setIsModalOpen(true);
  };
    ...
    <>
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold">Calendario de Reservaciones</h1>
                ...
                <div className="space-y-1 relative z-10">
                  {conferenciasDelDia.map((conf) => {
                    ...
                    return (
                      <div
                        key={conf.id}
                        onClick={(e) => handleConferenciaClick(conf, e)}
